...
//    private static final String DELETE_CUSTOMER_SQL = "DELETE FROM customer WHERE id = ?;";
    private static final String UPDATE_CUSTOMER_SQL = "UPDATE customer SET name_customer = ?,age_customer = ?, render_customer = ?, " +
            "email_customer = ?, address_customer = ?, phone_customer = ? WHERE account_customer = ?;";
    private static final String UPDATE_PASSWORD_SQL = "UPDATE customer SET password_customer = ? WHERE account_customer = ?;";
    ...
    @Override
    public boolean updatePasswordCustomer(String account, String newPassword) {
        boolean rowUpdated = false;
        try (Connection connection = getConnection();
    ...
    public Customer selectCustomerByName(String account) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                if(rs.getString("name_customer") == null){
                    return null;
                }else {
